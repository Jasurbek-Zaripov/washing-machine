    ...
    <div class="container mt-5">
        ...
        <div class="row mt-5">
            <div
                ...
                v-for="info of data.items"
                :key="info.img"
            >
                <div
                    class="card mb-5 border-color"
                    style="
                        max-width: 18rem;
                        min-height: 155px;
                        min-width: 350px;
        ...
        <div class="mt-5">
            ...
            <div class="row">
                <div
                    class="col mb-5"
                    v-for="(problem, index) of data.problems"
                    :key="index"
                >
                    <div class="card shadow" style="width: 18rem">
                        <img
                            :src="problem.img"
                            style="width: 286px; height: 203px"
                            class="card-img-top"
                            alt="..."
                        />
                        <div class="card-body">
                            <h5
                                class="card-title"
                                style="height: 3rem; overflow-y: hidden"
                            >
                                {{ problem.title }}
                            </h5>
        ...
        <div>
            ...
            <div class="row">
                <div
                    class="col bb d-flex align-items-center justify-content-between px-5 py-3 m-2 text-nowrap"
                    v-for="(price, idx) of data.price.items"
                    :key="idx"
                >
        ...
        <div class="mt-5">
            ...
            <div class="row w-100">
                <div
                    class="col-xl-5 shadow m-3 step-body"
                    v-for="(step, idx) of data.steps.items"
                    :key="idx"
                >
                    <div class="w-50 p-3">
                        <h1>{{ '0' + (idx + 1) }}</h1>
        ...
        <div class="mt-5 row" style="flex-direction: column-reverse">
            <div class="col google-maps mt-3">
                <iframe
                    ...
                    width="100%"
                    height="100%"
                    style="border: 0; border-radius: 5px; min-height: 25rem"
                    allowfullscreen=""
                    loading="lazy"
            ...
            <div class="col">
                ...
                >
                    <img
                        ...
                        class="logo me-2"
                    />
                    <h3 class="text-uppercase m-0 about">
                        {{ data.info.title }}
                    </h3>
                </div>
                <p>{{ data.info.body1 }}</p>
