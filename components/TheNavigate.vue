    ...
    <div class="head" :class="mode && 'light'">
        <header class="row shadow px-3 mb-3">
            ...
            >
                <img
                    class="ms-5"
                    src="/company/orange.png"
                    style="height: 45px"
                />
            </div>
            <div
                class="col d-flex justify-content-start align-items-center navigator-nav"
            >
                <nav>
                    <ul>
                        <li class="text-nowrap">
                            <a
                                :class="mode && 'light-color'"
                                class="text-opacity"
                                :data-text="'&nbsp;' + data.menu.home"
                                href="#"
                                >&nbsp;{{ data.menu.home }}&nbsp;</a
                            >
                        </li>
            ...
            <div class="col d-flex align-items-center justify-content-center">
                <a class="coll" href="tel://+998999891414"
                    ><img
                        class="logo"
                        height="25px"
                        style="height: 25px"
...
function change() {
    ...
    data.value.img =
        lang.now == 'ru' ? store.get('ru/lang') : store.get('uz/lang');
    data.value.menu =
        lang.now == 'ru' ? store.get('ru/menu') : store.get('uz/menu');
    event.emit('lang');
}
</script>
